...
pub fn run_NtProtectVirtualMemory(hProcess: windows.HANDLE, ppBaseAddress: *?*anyopaque, regionSize: *usize, NewProtection: u32, OldProtection: *u32) callconv(.C) windows.NTSTATUS {
